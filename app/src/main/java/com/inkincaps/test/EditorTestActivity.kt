...
import com.inkincaps.test.EditorTestActivity
...
class EditorTestActivity : AppCompatActivity() {
    ...
    private fun setUpEditor() {
        ...
        findViewById<View>(R.id.action_color).setOnClickListener(object : View.OnClickListener {
...
//                                Toast.makeText(this, "picked" + colorHex(color), Toast.LENGTH_LONG).show();
...
//        startActivity(intent);
    ...
    private fun insertMacro(): View {
        val view = layoutInflater.inflate(R.layout.layout_authored_by, null)
